...
3. Dan will continue data analysis w/warped data
...
1. Bad lat/lon for FIU_WQMP_RECENT (FIU_WQMP and FIU_WQMP_HISTORICAL is ok)
2. Bad lat/lon for PALM_BEACH and PALM_BEACH_STORET
3. Bad lat/lon for BROWARD_STORET (BROWARD is ok)
4. Bad lat/lon for BBWQ_STORET (BBWQ is ok)
